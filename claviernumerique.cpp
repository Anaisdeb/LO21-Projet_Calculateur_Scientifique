...
ClavierNumerique::ClavierNumerique(QWidget* parent) : QWidget(parent) {
    ...
    connect(div, SIGNAL(clicked()), parent, SLOT(clickOpBinaire()));
    QPushButton* mod = new QPushButton("MOD");
    connect(mod, SIGNAL(clicked()), parent, SLOT(clickOpBinaire()));
    QPushButton* neg = new QPushButton("NEG");
    connect(neg, SIGNAL(clicked()), parent, SLOT(clickOpUnaire()));
    QPushButton* eval = new QPushButton("EVAL");
    connect(eval, SIGNAL(clicked()), parent, SLOT(clickOpBinaire()));
